...
class SerialSocket extends BluetoothGattCallback {
    ...
    private static final UUID BLUETOOTH_LE_CYBLE_SERVICE  = UUID.fromString("0003CDD0-0000-1000-8000-00805f9b0131");
    private static final UUID BLUETOOTH_LE_CYBLE_CHAR_TX  = UUID.fromString("0003CDD2-0000-1000-8000-00805f9b0131");
    private static final UUID BLUETOOTH_LE_CYBLE_CHAR_RX  = UUID.fromString("0003CDD1-0000-1000-8000-00805f9b0131");


    private static final UUID BLUETOOTH_LE_EZ_BLE_SERVICE  = UUID.fromString("65333333-A115-11E2-9E9A-0800200CA100");
    private static final UUID BLUETOOTH_LE_EZ_BLE_CHAR_RW  = UUID.fromString("65333333-A115-11E2-9E9A-0800200CA200");
    ...
    private void connectCharacteristics1(BluetoothGatt gatt) {
        ...
        for (BluetoothGattService gattService : gatt.getServices()) {
            ...
            if (gattService.getUuid().equals(BLUETOOTH_LE_CYBLE_SERVICE))
                delegate = new CYBLEDelegate();
            if (gattService.getUuid().equals(BLUETOOTH_LE_EZ_BLE_SERVICE))
                delegate = new EZ_BLEDelegate();
    ...
    private class CYBLEDelegate extends DeviceDelegate {
        @Override
        boolean connectCharacteristics(BluetoothGattService gattService) {
            Log.d(TAG, "service cyble uart");
            readCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_CYBLE_CHAR_RX);
            writeCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_CYBLE_CHAR_TX);
            return true;
        }
    }

    private class EZ_BLEDelegate extends DeviceDelegate {
        @Override
        boolean connectCharacteristics(BluetoothGattService gattService) {
            Log.d(TAG, "service cyble uart");
            readCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_EZ_BLE_CHAR_RW);
            writeCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_EZ_BLE_CHAR_RW);
            return true;
        }
    }
